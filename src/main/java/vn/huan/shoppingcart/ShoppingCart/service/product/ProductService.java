...
import vn.huan.shoppingcart.ShoppingCart.exceptions.ProductNotFoundException;
...
public class ProductService implements  IProductService{
    ...
    @Override
    public List<Product> getProductsByCatergoryAndBrand(String category, String brand) {
